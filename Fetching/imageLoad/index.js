...
*/
    ...
    const promisesArr = [
        getImagePromise(imageUrlsArr[0]),
        getImagePromise(imageUrlsArr[1]),
        getImagePromise(imageUrlsArr[2])

    ] */
    
    const promisesArr = imageUrlsArr.map((url) => getImagePromise(url))
